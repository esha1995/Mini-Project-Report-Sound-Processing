This is the report written for a MatLab implementation of the simple HRTF model presented in the paper "An efficient HRTF model for 3d sound" by  C.P. Brown and R.O. Duda.
